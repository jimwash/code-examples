...
elevatorbank.push(new ev.Elevator("L1",0,ev.Directions.STANDING,0,20))
elevatorbank.push(new ev.Elevator("L2",0,ev.Directions.STANDING,0,20))
elevatorbank.push(new ev.Elevator("R1",0,ev.Directions.STANDING,0,20))
elevatorbank.push(new ev.Elevator("R2",0,ev.Directions.STANDING,0,20))
